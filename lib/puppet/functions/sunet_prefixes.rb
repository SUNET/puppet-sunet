...
Puppet::Functions.create_function(:sunet_prefixes) do
  ...
  [
      ...
      { "net": "54.193.83.241/32",      "family": "ip",  "comment": "ec2-54-193-83-241.us-west-1.compute.amazonaws.com", "resource_type": "seamlessaccess", "tags": ["knubbis", "infraca"] },
      ...
      { "net": "86.104.52.0/25",        "family": "ip",  "comment": "Sunet Cloud DCO", "resource_type": "SUNET", "tags": ["knubbis", "infraca", "acmec"] },
      ...
      { "net": "188.240.152.0/32",      "family": "ip",  "comment": "wiki.sunet.se(CDN IP)", "resource_type": "SUNET", "tags": ["acmec"] },
      ...
      { "net": "2001:6b0:303:500::/64", "family": "ip6", "comment": "OpenStack Public DCO", "resource_type": "SUNET", "tags": ["knubbis","infraca", "acmec"] },
      ...
      { "net": "2001:6b0:2100::/48",    "family": "ip",  "comment": "wiki.sunet.se(CDN IP)", "resource_type": "SUNET", "tags": ["acmec"] },
    ]
  end
end
