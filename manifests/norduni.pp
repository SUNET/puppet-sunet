class sunet::norduni {
    ...
    sunet::docker_run { 'norduni-postgres':
        ...
        imagetag => 'latest',
        volumes  => [
                      '/var/opt/norduni/data/postgresql:/var/lib/postgresql/data/',
                      '/var/opt/norduni/postgres/init/init-noclook-db.sh:/docker-entrypoint-initdb.d/init-noclook-db.sh'
                    ],
    ...
    sunet::docker_run { 'norduni-noclook':
        ...
        imagetag         => 'latest',
        volumes          => [
                              '/var/opt/norduni/noclook/etc/dotenv:/var/opt/norduni/norduni/src/niweb/.env:ro',
