...
define sunet::collabora::docs(
  ...
  $collabora_extra_params = ["extra_params=--o:num_prespawn_children=10 --o:ssl.cert_file_path=/certs/collabora.crt --o:ssl.key_file_path=/certs/collabora.key --o:ssl.ca_file_path=/certs/ca-certificates.crt --o:net.frame_ancestors=https://*"]
