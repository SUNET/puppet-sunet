class sunet::vc::broker(
 ...
 package { 'make': ensure => 'installed' }
  ...
  file { '/opt/vc/Makefile':
    ...
    owner => 'root',
    group => 'root',
    content => template("sunet/vc/broker/Makefile.erb")
  }
  ...
  # Compose
  sunet::docker_compose { 'vc_broker':
    content          => template('sunet/vc/broker/docker-compose.yml.erb'),
    service_name     => 'vc',
    compose_dir      => '/opt',
    compose_filename => 'docker-compose.yml',
    description      => 'VC-broker service',
  }
