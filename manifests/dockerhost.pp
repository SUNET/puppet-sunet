...
class sunet::dockerhost(
  ...
  Variant[String, Boolean] $docker_network    = lookup('dockerhost_docker_network', undef, undef, '172.18.0.0/22'),
  String $docker_network_v6                   = lookup('dockerhost_docker_network_v6', undef, undef, 'fd0c:d0c::/64'),  # default bridge
