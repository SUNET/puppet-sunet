...
class sunet::nagiosapi($version='latest',$api_port=5667) {
   ...
   $nagios_ip_v4 = lookup('nagios_ip_v4', '109.105.111.111')
   $nagios_ip_v6 = lookup('nagios_ip_v6', '2001:948:4:6::111')
   $api_clients  = lookup('nagios_api_clients', ['127.0.0.1','127.0.1.1',$nagios_ip_v4,$nagios_ip_v6])
