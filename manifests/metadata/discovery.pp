...
class sunet::metadata::discovery(
    ...
    Optional[String] $mdq_search_url = lookup('mdq_search_url', String, undef, undef),
    Optional[String] $src = lookup('src', String, undef, undef),
    Optional[String] $src_trust = lookup('src_trust', String, undef, undef),
    Optional[String] $whitelist = lookup('whitelist', String, undef, undef),
